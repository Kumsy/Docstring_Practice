...
def is_mel(name, email):
    ...
    False
    >>> is_mel('Mel Melitpolski', 'somebody@awesome.com')
    True
    >>> is_mel('Sarah.', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    Example:
    >>> treats = [{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'drink'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'drink'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'appetizer')

    >>> treat = [ {'type': 'dessert'}, {'type': 'dessert'}, {'type': 'cake'}]
    >>> most_and_least_common_type(treat)
    ('dessert', 'cake')

    >>> tie_list = [{'type':'cake'}, {'type':'soda'}, {'type':'cake'}, {'type':'soda'}]
    >>> most_and_least_common_type(tie_list)
    ('cake', 'cake')

    >>> another_empty = []
    >>> most_and_least_common_type(another_empty)
    (None, None)
